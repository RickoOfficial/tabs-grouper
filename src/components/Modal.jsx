...
export function Modal({ children, title, show, ...props }) {
	return (
		<div
			className={
		...
		>
			<div className="modal__blackout absolute top-0 left-0 w-full h-full bg-gray-600 bg-opacity-50"></div>
			<div className="modal__content relative top-1/2 left-1/2 w-11/12 bg-white px-4 py-2 rounded -translate-x-1/2 -translate-y-1/2">
				...
				<div className="modal__title mb-4 w-11/12 text-lg">{title}</div>
